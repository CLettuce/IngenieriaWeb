    ...
    public abstract class cModel
    {
        public class Productos
        {
            ...
            public static List<Productos> ListarProductos()
            {
                ...
                {
                    new Productos(1,"Ubeda","Nvidia Quadro RTX 6000", 200, 50.00, Convert.ToDateTime("2023-05-25")),
                    ...
                    new Productos(6,"Orlando", "Nvidia GeForce RTX 3060 Ti", 15, 40.00, Convert.ToDateTime("2022-06-11")),
